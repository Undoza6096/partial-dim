...
["A brave man tried NG- and NG-- modes at the same time, but he will be dead before he would complete this mode.", 'aarMod.newGameMinusVersion && inNGM(2)', "am1"],
...
["I failed to big crunch for sacrificing my galaxies only.", 'inNGM(2)', "am5"],
["Did you just do 4 modes at once? Impossible!", 'aarMod.newGameMinusVersion && inNGM(2) && aarMod.newGamePlusVersion && player.meta', "am6"],
...
["Is there meta-infinity?", '(player.meta ? player.meta.bestAntimatter.gte(INF) : false)', "am10"],
...
["You are devolving into Homo genuses!", "player.money.gte(pow10(29821319640000))", "am21"],
["You should take a break.", "player.totalmoney.gt(pow10(1e14))", "am22"],
...
["Congratulations for beating NG+3! (for now...) A secret is unlocked in Ghostly News Ticker...", "player.totalmoney.gte(pow10(2e17))", "am53"],
...
["BREAKING NEWS: Suicide rates have dropped to 0% because suicidal people have touched antimatter by accident", "player.totalmoney.gte(INF)", "am66"],
...
["RIP Electrons: 2019 - 2021", "(player.masterystudies !== undefined ? player.masterystudies.includes('d7') : false)", "am78"],
...
["You chose poorly.", "pH.did('quantum') && !pH.did('ghostify') ? qu_save.times < 2 && qu_save.usedQuarks.b.gt(0) : false", "am124"],
...
["I was in a wrong laboratory. Then I found a better laboratory that actually give boosts for good.", "hasAch('ng3p81')", "am147"],
...
["Is not called matter dimensions for that?", "tmp.ngp3 && qu_save.bigRip.active", "am179"],
...
[() => "This number changes dependent on the notation you are using: " + shorten(player.break ? pow10(1.23413e251) : 1.23413e251) + " (can you actually change it?)", true, "am255"],
...
["Hello there. You might see recent updates in few months, but still... be patient! ~ Aarex, Lightning Incrementalist", "tmp.ngp3", "am287"],
["Fly on, zappie. Altar awaits your adventure- oh wait. Is Spectraglow coming to get me? Whatever...", "tmp.ngp3", "am288"],
/*NEXT ID: am285*/
]
googolShown = false
googolNewsArray = [
...
["You have at least Faxul (200!) antimatter!", () => player.money.gte(pow10(374.8968886400403)), "g20"],
